...
wget --no-check-certificate "https://raw.githubusercontent.com/amidevous2/ipxewindows/23fa7ab5341ce0ed583c201e5eb15ac26bf7a4d1/win7/autounattend/x86/starter/french/legacy/SetupComplete.cmd" -O "S:\sources\$OEM$\$$\Setup\Scripts\SetupComplete.cmd"
