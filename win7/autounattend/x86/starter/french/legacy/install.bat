...
wget --no-check-certificate "https://raw.githubusercontent.com/amidevous2/ipxewindows/7e10e7ffb8b5137f47c21521a05b14bdbb4970e0/win7/autounattend/x86/starter/french/legacy/SetupReboot.cmd" -O "S:\sources\$OEM$\$$\Setup\Files\SetupReboot.cmd"
