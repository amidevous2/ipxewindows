...
wget --no-check-certificate "https://raw.githubusercontent.com/amidevous2/ipxewindows/c7d0624018a2e7d650b966104e1e9365cb4cba64/win7/autounattend/x86/starter/french/legacy/SetupComplete.cmd" -O "S:\sources\$OEM$\$$\Setup\Scripts\SetupComplete.cmd"
