...
wget --no-check-certificate "https://raw.githubusercontent.com/amidevous2/ipxewindows/bafc92294e1d0a76ec7d5658100ad6eaf0c697bd/win7/autounattend/x86/starter/french/legacy/SetupComplete.cmd" -O "S:\sources\$OEM$\$$\Setup\Scripts\SetupComplete.cmd"
