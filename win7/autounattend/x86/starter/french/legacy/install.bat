...
wget --no-check-certificate "https://raw.githubusercontent.com/amidevous2/ipxewindows/6eeef093776f641765f7d624ac1e682ff0bb8df8/win7/autounattend/x86/starter/french/legacy/SetupComplete2.cmd" -O "S:\sources\$OEM$\$$\Setup\Files\SetupComplete2.cmd"
